...
Today we're going to keep working on our Tic Tac Toe class. We'll also spend
some time going over Horstmann's graphics libraries.

Horstmann
---------

Here's the contents of  `ccc_shap.h`
